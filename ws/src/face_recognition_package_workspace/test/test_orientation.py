...
TEST_IMAGES = [
    f"{PKG_DIR}/test/test_images/orientation/11-01.jpg",
    f"{PKG_DIR}/test/test_images/orientation/11-02.jpg",
    f"{PKG_DIR}/test/test_images/orientation/11-03.jpg",
    f"{PKG_DIR}/test/test_images/orientation/11-04.jpg",
    f"{PKG_DIR}/test/test_images/orientation/11-05.jpg",
    f"{PKG_DIR}/test/test_images/orientation/11-06.jpg",
    f"{PKG_DIR}/test/test_images/orientation/11-07.jpg",
    f"{PKG_DIR}/test/test_images/orientation/11-08.jpg",
    f"{PKG_DIR}/test/test_images/orientation/11-09.jpg",
    f"{PKG_DIR}/test/test_images/orientation/11-10.jpg",
]

output_filenames = [
    f"{PKG_DIR}/test/test_images/orientation/output/o-11-01.jpg",
    f"{PKG_DIR}/test/test_images/orientation/output/o-11-02.jpg",
    f"{PKG_DIR}/test/test_images/orientation/output/o-11-03.jpg",
    f"{PKG_DIR}/test/test_images/orientation/output/o-11-04.jpg",
    f"{PKG_DIR}/test/test_images/orientation/output/o-11-05.jpg",
    f"{PKG_DIR}/test/test_images/orientation/output/o-11-06.jpg",
    f"{PKG_DIR}/test/test_images/orientation/output/o-11-07.jpg",
    f"{PKG_DIR}/test/test_images/orientation/output/o-11-08.jpg",
    f"{PKG_DIR}/test/test_images/orientation/output/o-11-09.jpg",
    f"{PKG_DIR}/test/test_images/orientation/output/o-11-10.jpg",
]

import face_recognition
known_image = face_recognition.load_image_file(f"{PKG_DIR}/test/test_images/orientation/11-14.jpg")
...
for image, output_file in zip(TEST_IMAGES, output_filenames):
    ...
    print("Timings at image {}:".format(size))
